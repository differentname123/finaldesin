...
u8 zxh_atk_8266_wifista_test(void);	//WIFI STA测试
u8 zxh_atk_8266_wifista_test1(void);	//WIFI STA测试
void qiuqiuni(char *ssid, char *password, char *ip, char *port);	//WIFI STA测试
...
extern const u8* zxh_wifista_ssid;		//WIFI STA SSID
extern const u8* zxh_wifista_encryption;//WIFI STA 加密方式
extern const u8* zxh_wifista_password; 	//WIFI STA 密码
